...
Knapsack kryptosystémy patria medzi skoré návrhy kryptografie s verejným
kľúčom založené na probléme subset-sum. Hoci je rozhodovacia verzia tohto
problému NP-úplná, konkrétne inštancie vytvárané kryptosystémom môžu obsahovať
štruktúru, ktorú vie útočník využiť. V tejto práci skúmame klasický
Merkleho--Hellmanov knapsack kryptosystém, jeho matematické pozadie, známe
slabiny a vybrané historické variácie. Opisujeme najmä úlohu superrastúcich
postupností, Shamirov polynomiálny útok, nízkohustotné mriežkové útoky,
iterované konštrukcie a Chorov--Rivestov kryptosystém. Praktická časť práce
obsahuje implementáciu klasického, permutovaného a jednoducho iterovaného
variantu v jazyku C. Pomocou experimentov overujeme správnosť implementácie,
porovnávame beh jednotlivých variantov a sledujeme vplyv parametrov na hustotu
verejného knapsacku. Výsledky podporujú hlavný záver práce: klasické knapsack
kryptosystémy sú dnes dôležité najmä ako historický a vzdelávací príklad toho,
že teoretická náročnosť problému sama osebe nezaručuje bezpečnosť konkrétnej
kryptografickej konštrukcie.
